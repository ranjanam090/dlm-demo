...
<body>
  ...
  <main class="container">
    <section class="stage" id="stage" aria-label="Dynamic load management animation">
      ...
      <div class="stalls" id="stalls" role="list" aria-label="Charging stalls"></div>
  ...
  <footer class="container foot">
    <p>
      Built for demo purposes — clean-room recreation. Respects reduced‑motion and pauses when off‑screen.
    </p>
  </footer>

  <!-- IMPORTANT: relative path, defer so DOM is ready -->
  app.js</script>
</body>
</html>
